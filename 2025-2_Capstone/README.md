...
## 1. 배경
- 본 과제는 25-2 국립금오공과대학교 RISE사업단 주최하 기업연계형 캡스톤 프로젝트의 일환으로써, LIG-Nex1과 NPLAB 연구실의 협력으로 진행됨
- 보안상의 이유로 해당 Github branch는 초대받은 사용자만 내용을 볼 수 있음
...
(베이지안 모델 설계에 대한 자세한 내용은 결과보고서를 참고)
