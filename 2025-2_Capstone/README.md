# 0. 배경
- 본 과제는 25-2 국립금오공과대학교 RISE사업단 주최하 기업연계형 캡스톤 프로젝트 일환으로써, LIG-Nex1과 NPLAB 연구실의 협력으로 진행되었음.
...
# 1. 개요
- 프로젝트 설명: 무인기 탑재 IMU의 다시점 점검 데이터를 가지고 항법 드리프트 열화 모델을 설계, 잔여유효수명(RUL, Remaining Useful Life)를 확률로 예측
